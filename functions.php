 ...
 */
function wimp_register_custom_background() {
	$args = array(
		'default-color' => 'ffffff',
		'default-image' => '',
	);

	$args = apply_filters( 'wimp_custom_background_args', $args );
...
add_action( 'after_setup_theme', 'wimp_register_custom_background' );
...
function wimp_scripts() {
	...
	if ( is_singular() && wp_attachment_is_image() ) {
		wp_enqueue_script( 'wimp-keyboard-image-navigation', get_template_directory_uri() . '/js/keyboard-image-navigation.js', array( 'jquery' ), '20120202' );
	}
}
